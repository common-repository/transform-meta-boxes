...
class TransformMetaBoxesPlugin {
	...
	public function __construct() {
		...
		if (isset($this->options['taxonomies_to_change']) and sizeof($this->options['taxonomies_to_change'])) {
	...
	public function add_settings_page() {
		add_options_page(__('Transform Meta Boxes Options', 'TransformMetaBoxes'), __('Transform Meta Boxes', 'TransformMetaBoxes'), 'manage_options', __CLASS__.'/settings.php', array($this, 'display_settings_page'));
	}
